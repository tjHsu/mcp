...
c *** Advance coordinates and velocities
	   Do ipart=1, Npart	
       x(1,ipart)=x(1,ipart)+v(1,ipart)*dt
       x(2,ipart)=x(2,ipart)+v(2,ipart)*dt
       v(1,ipart)=v(1,ipart)+a(1,ipart)*dt
       v(2,ipart)=v(2,ipart)+a(2,ipart)*dt       
       END Do
